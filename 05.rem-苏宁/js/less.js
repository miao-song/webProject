...
module.exports = function(environment) {
    ...
    ImportManager.prototype.push = function (path, tryAppendLessExtension, currentFileInfo, importOptions, callback) {
        ...
        var loadFileCallback = function(loadedFile) {
            ...
            // - If path of imported file is '../mixins.less.less' and rootpath is 'less/',
    ...
    return {
        ...
        parsers: parsers = {
            ...
            mixin: {
                ...
                //
                //     #mixins.less > .square(#fff);
                //     .rounded(4px, black);
                //     .button;
                //
                // The `while` loop is there because mixins.less can be
...
var Node = require("./node"),
    Selector = require("../lib/zepto/selector"),
...
tree.Selector = require('../lib/zepto/selector');
...
var Selector = require("../lib/zepto/selector"),
        ...
        if (rsRules[i].type === "MixinCall") {
            ...
            rules = rsRules[i].eval(context).filter(function(r) {
                if ((r instanceof Rule) && r.variable) {
                    ...
                    // but we need a way to "return" variable from mixins.less
